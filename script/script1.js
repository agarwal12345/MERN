document.getElementById("sendButton").addEventListener("click", function () {
  ...
  if (firstName === "") {
    ...
    document.getElementById("firstname").parentNode.style.border =
      "0.5px solid red";
  ...
  if (lastName === "") {
    ...
    document.getElementById("lastname").parentNode.style.border =
      "0.5px solid red";
  ...
  if (email === "") {
    ...
    document.getElementById("email").parentNode.style.border =
      "0.5px solid red";
  ...
  if (phone === "") {
    ...
    document.getElementById("phone").parentNode.style.border =
      "0.5px solid red";
  ...
  if (address === "") {
    ...
    document.getElementById("address").parentNode.style.border =
      "0.5px solid red";
  ...
  if (state === "Select a state...") {
    ...
    document.getElementById("state").parentNode.style.border =
      "0.5px solid red";
  ...
  if (!hostingYes && !hostingNo) {
    document.getElementById("hostingError").textContent =
  ...
  if (projectDescription === "") {
    ...
    document.getElementById("project_description").parentNode.style.border =
      "0.5px solid red";
